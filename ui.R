ui <- function(request) {
  ...
  page_fluid(
    ...
    tags$head(
      ...
      tags$meta(property = "og:image",            content = "https://raw.githubusercontent.com/parack/ai-music-governance-cbc/main/www/preview.png?v=3"),
      tags$meta(property = "og:image:secure_url", content = "https://raw.githubusercontent.com/parack/ai-music-governance-cbc/main/www/preview.png?v=3"),
      ...
      tags$meta(name = "twitter:image",       content = "https://raw.githubusercontent.com/parack/ai-music-governance-cbc/main/www/preview.png?v=3"),
